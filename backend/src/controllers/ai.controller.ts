...
Vai trò "Quản lý chi nhánh" có tab Tổng quan (dashboard, phạm vi riêng chi nhánh của họ) và một nghiệp vụ thật trong luồng Đơn nhập hàng: xác nhận đã đặt hàng với nhà cung cấp. Cụ thể, đơn nhập hàng có trạng thái theo thứ tự pending → ordered → debt/completed (hoặc bị huỷ thành cancelled ở bước pending/ordered): Quản lý tạo đơn (trạng thái "pending"), Quản lý chi nhánh của đúng chi nhánh đó xác nhận đã đặt hàng với nhà cung cấp (chuyển sang "ordered"), rồi Nhân viên kho mới được xác nhận nhận hàng thực tế (chuyển sang "debt" nếu còn nợ hoặc "completed"). Quản lý chi nhánh chỉ xác nhận được đơn thuộc đúng chi nhánh mình, không xem/xác nhận được đơn chi nhánh khác. Tính năng này hiện có ở tầng API (chưa chắc đã có nút bấm ở giao diện tab Tổng quan) — nếu được hỏi các tính năng khác ngoài xác nhận đặt hàng, trả lời trung thực là hiện chưa có, không bịa ra.
